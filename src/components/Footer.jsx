      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-links">
            <h4>Services</h4>
            <ul>
              <li><a href="#">Wedding Cinematography</a></li>
              <li><a href="#">Commercial Production</a></li>
          ...
          <div className="footer-newsletter">
            <h4>Newsletter</h4>
            <p>Subscribe for updates and behind-the-scenes content.</p>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Lekhan Media Filmworks. All rights reserved.</p>
